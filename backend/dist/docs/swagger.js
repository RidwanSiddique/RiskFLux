...
exports.swaggerSpec = {
    ...
    info: {
        title: "RiskFlux API",
        description: "Natural hazard risk assessment API. Calculate flood, storm, and snow risk scores based on geographic and environmental factors.",
        version: "1.0.0",
        contact: {
    ...
    paths: {
        "/api/v1/hazard-score": {
            post: {
                ...
                description: "Calculate comprehensive natural hazard risk score for a given location including flood, storm, and snow components.",
                requestBody: {
                    required: true,
                    content: {
                        "application/json": {
